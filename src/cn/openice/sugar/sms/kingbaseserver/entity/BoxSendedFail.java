...
/**
 * SmsBoxsendedfail entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sms_boxsendedfail")
public class BoxSendedFail implements java.io.Serializable {
	...
	*/
	...
	private static final long serialVersionUID = 736809673430333695L;
	private String id;
	...
	/** default constructor */
	public BoxSendedFail() {
	}

	/** minimal constructor */
	public BoxSendedFail(String id) {
		this.id = id;
	}

	/** full constructor */
	public BoxSendedFail(String id, String appid, String sender,
			...
			String innerid, String errorcode, String validityperiod,
			String ifreceipt, String outteruser) {
		this.id = id;
		this.appid = appid;
		this.sender = sender;
